...
@ManagedBean(name="editAssociatedSurveyStructures")
@ViewScoped
public class EditAssociatedSurveyStructures {
	@EJB
	...
	@PostConstruct
	public void init(){
		System.out.println("********************** INIT ADMIN ASSOCIACTE");
	...
	public void loadAssociatedSurveyStructures(){
		...
		List<SurveyStructure> tmpListSS = srvSurveysEngine.getSurveyStructuresBy2State(SurveyStructureState.CREATING, SurveyStructureState.IN_EDITION);
	...
	public String associateSurveyStructures(){
		...
		return "admin_associated_survey_structures";
	...
	public void selectionSurveyStructureListener(RowSelectorEvent event) {
		...
		System.out.println("*************************** tmpSurveyS.getName(): "+tmpSurveyS.getName());
