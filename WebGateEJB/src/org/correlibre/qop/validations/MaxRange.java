...
public class MaxRange extends Expression {

	public MaxRange() throws QopException {
		super();
	}

	@Override
	protected String conformExpression(Question question,
			Map<Question, String> answers, Validation validation) {
		return question.getKey()+"<="+validation.getRule();
